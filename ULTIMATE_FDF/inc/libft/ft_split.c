...
/*   Updated: 2024/07/11 18:13:09 by jsommet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

size_t	ft_countword(char *str, char characters)
{
	size_t	count;
	size_t	i;
...
static size_t	ft_countletter(char *str, char characters)
{
	size_t	i;
...
static char	**spliit(char *str, char characters, char **array,
		size_t words_count)
{
	size_t	i;
	size_t	j;
...
char	**ft_split(char *str, char characters)
{
	char	**tab;
	size_t	words;
